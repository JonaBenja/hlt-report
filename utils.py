...
def load_semantic_model(model_type):
    """
    Function to load word embedding models needed based on value of model_type
    """
    if model_type == 'glove':
...
def load_classifier(classifier_type, model_type):
    """
    Function to load trained classifiers needed based on value of classifier_type and  model_type
    """
